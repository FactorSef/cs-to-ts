...
export function parseRegex(text: string, regex: string | RegExp, parse: (match: any) => any): IParseResult {
...
export function firstMatch(code: string, parsers: Array<ParseFn>): IParseResult {
    let firstMatch = null;
